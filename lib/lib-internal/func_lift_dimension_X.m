function X_lift = func_lift_dimension_X(X, opt)
% func_lift_dimension_X lifts the dimension of X using Koopman operator
% 
% Here, fb is defined according to line 24 in rbf.m of Ref.2, where 
% fb(n, i) = (X(n, :) - c(i, :, n)) * (X(n, :) - c(i, :, n))'
%
