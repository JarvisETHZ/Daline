function model = func_algorithm_LS_REC(data, varargin)
...
[model.Beta, model.trainTime] = func_solve_LS_Rec(X_train_old, Y_train_old, X_train_new, Y_train_new, opt.LSR.forgetFactor, opt.LSR.initializeP, opt.LSR.largeValueP);
