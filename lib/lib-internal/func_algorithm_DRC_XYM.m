function model = func_algorithm_DRC_XYM(data, varargin)
% Distributionally robust chance-constrained
% programming, consider X and Y as random variables, moment-based
% ambiguity set
%
...
% Train the model
[model.Beta, model.success] = func_solve_DRCC_randXY_moment(X_train, Y_train, opt);
