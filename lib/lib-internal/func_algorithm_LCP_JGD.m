function model = func_algorithm_LCP_JGD(data, varargin)
% Linearly constrained programming with Jacobian guidance constraints
% 
...
%     objective = sum(sum((Y_train - X_train * B - repmat(C, num_sample, 1)).^2)); % Doesn't work very well
