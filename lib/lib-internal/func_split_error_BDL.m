function [errorStruct, predStruct, trueStruct] = func_split_error_BDL(Y, error, Y_pred, Y_true)
%
...
%  Y.test.Va, Y.test.P, Y.test.Vm, Y.test.PF, Y.test.PT, Y.test.QF, Y.test.QT, Y.test.Q
