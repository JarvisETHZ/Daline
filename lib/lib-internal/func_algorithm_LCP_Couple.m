function result = func_algorithm_LCP_Couple(data, opt)
...
% branch flows and Vm, Va. That is, Vm and Va are assumed as independent
% variables. Although this is impossible in reality, as the majority of Vm
...
% average error is 0.0077, without: 8.7316e-04. Hence, the physical
% constraints may not always improve the accuracy. 
% 
% Note: the coupling constraints are only valid for branch flow model
% taking Va and Vm as predictors. 
%
