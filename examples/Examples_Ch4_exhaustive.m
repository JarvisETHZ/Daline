...
%% 4.2.7 Least squares with Huber loss function: an equivalent solution (solvers: fmincon, Mosek, Gurobi, recommend: yalmip+fmincon+indivi)
...
%% 4.2.14 Weighed least squares (solvers: quadprog, Mosek, Gurobi, SDPT3, SeDuMi, recommend: cvx+SeDuMi+whole)
...
%% 4.5.1 Ordinary support vector regression: a direct solution (solvers: quadprog, Mosek, Gurobi, recommend: yalmip+quadprog+indivi)
...
%% 4.5.3 Support vector regression with ridge regression (solvers: quadprog, Mosek, Gurobi, recommend: yalmip+quadprog+indivi)
...
%% 4.6.1 Linearly constrained programming with box constraints (solvers: quadprog, Mosek, Gurobi, SDPT3, SeDuMi, recommend: SeDuMi)
...
%% 4.6.2 Linearly constrained programming without box constraints (solvers: quadprog, Mosek, Gurobi, SDPT3, SeDuMi, recommend: SeDuMi)
...
%% 4.6.5 Linearly constrained programming with coupling constraints (solvers: quadprog, Mosek, Gurobi, SDPT3, SeDuMi, recommend: quadprog)
...
%% 4.6.6 Linearly constrained programming without coupling constraints (solvers: quadprog, Mosek, Gurobi, SDPT3, SeDuMi, recommend: quadprog)
...
%% 4.7.1 Moment-based distributionally robust chance-constrained programming with X as random variable (solvers: Mosek, SDPT3, SeDuMi, recommend: cvx+SeDuMi+whole for small cases, cvx+SeDuMi+indivi for large cases)
...
%% 4.7.2 Moment-based distributionally robust chance-constrained programming with X and Y as random variables (solvers: Mosek, SDPT3, SeDuMi, recommend: cvx+SeDuMi+whole for small cases, cvx+SeDuMi+indivi for large cases)
dataN = daline.normalize(data);
...
%% 4.7.3 Divergence-based distributionally robust chance-constrained programming with X and Y as random variables (solvers: Mosek, Gurobi, recommend: yalmip+Gurobi)
dataN = daline.normalize(data);
