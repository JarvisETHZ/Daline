...
model = daline.all('case39', 'outlier.switchTrain', 1, 'outlier.percentage', 0.01, 'filOut.switchTrain', 1);
model = daline.all('case39', 'outlier.switchTest', 1, 'outlier.percentage', 0.2, 'filOut.switchTest', 1, 'filOut.method', 'median');
